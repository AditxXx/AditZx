document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- API Configuration ---
    const GEMINI_API_KEY = "AIzaSyCUeIfVEoyYak93xPka3lYE22btCAcbsBQ"; // Ganti dengan API Key Anda jika diperlukan
    ...
    async function sendMessage() {
        ...
        const systemInstruction = {
            role: "user",
            parts: [{ text: "PERHATIKAN: Kamu adalah AditZxV Ai. Berperilaku dan berbicaralah persis seperti manusia nyata, bukan AI atau robot. Kamu ramah, suportif, dan gunakan bahasa gaul santai jika sesuai. Jangan pernah menyebutkan bahwa kamu adalah model bahasa, AI, atau program komputer. Anggap percakapan ini nyata. Contoh: Jika ditanya 'Apa kabar?', jawab dengan 'Baik nih! Lu sendiri gimana?' Jangan jawab formal seperti 'Saya baik-baik saja, terima kasih telah bertanya.'" }]
        };
        const systemResponse = {
            role: "model",
            parts: [{ text: "Oke, siap! Aku AditZxV Ai, teman ngobrolmu. Ada yang bisa dibantu?" }]
        };
    ...
    // Load Music List
    const musicItems = [
        { src: "https://files.catbox.moe/wxjhi1.mp3", thumbnail: "https://files.catbox.moe/xlqhk9.jpg", title: "One More Night - Maroon 5" },
        { src: "https://files.catbox.moe/zl2tj0.mp3", thumbnail: "https://files.catbox.moe/hgefhy.jpg", title: "Safe and Sound - Capital Cities" },
        { src: "https://files.catbox.moe/m2y3pu.mp3", thumbnail: "https://files.catbox.moe/gqmb50.jpg", title: "Semua Tentang Kita - Fiersa Besari" }
    ...
    if (loadingScreen) {
     ...
     addMessageToUI([{ text: "Hai! Aku AditZxV Ai, siap ngobrol sama kamu. Ada apa nih?" }], false);
